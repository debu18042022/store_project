  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <div class="needs-validation was-validated" novalidate="">
        ...
        <hr class="mb-4">
        <td><button data-bs-toggle='modal' data-bs-target='#Modal_button_edit' 
        class='btn btn-primary btn-lg btn-block checkout edit_row' id=".$row[$i]['prod_id'].">Continue to checkout</button></td>
...
<div class="modal fade" id="Modal_button_edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">your order has succes registered</h6>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
       ...
       <script>
           $(document).ready(function(){
            $(document).on("click",".checkout",function(){
             ...
             if(first_name.length>0 && last_name.length>0 && email.length>0 && address.length>0 && country.length>0 && state.length>0 && zip.length>0){
                $.ajax({
                ...
                if(first_name.length==0){alert("first name field is required");}
